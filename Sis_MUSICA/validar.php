...
echo"<html> 
       <head>
         <link rel='stylesheet' href='css/estilos_bienvenida.css' type='text/css'>
       </head>
       <body>";
    ...
    if (password_verify($password, $clave_bd)) {
      ...
      if ($rs) {
            ...
            if (!isset($_SESSION['visitado'])) {
              // Si es la primera visita de la sesión
              $_SESSION['visitado'] = true; // Marca la sesión como visitada
       ...
       foreach ($rs as $k => $linea) {
               ...
               $_SESSION["sesion_usuario"] = $linea["usuario_principal"];
        ...
        echo"<h1>".$mensage1."</h1>";
        echo"<h1 style='color:white'>".$nom_completo."</h1>";
